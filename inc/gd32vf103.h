...
#define RCC_APB2ENR_USART0EN_Msk ( 0x1UL << RCC_APB2ENR_USART0EN_Pos )
#define RCC_APB2ENR_USART0EN     ( RCC_APB2ENR_USART0EN_Msk )
...
#define USART_STAT_CTSF_Pos   (9)
#define USART_STAT_CTSF_Msk   (0x1UL << USART_STAT_CTSF_Pos)
#define USART_STAT_CTSF       (USART_STAT_CTSF_Msk)
#define USART_STAT_LBDF_Pos   (8)
#define USART_STAT_LBDF_Msk   (0x1UL << USART_STAT_LBDF_Pos)
#define USART_STAT_LBDF       (USART_STAT_LBDF_Msk)
#define USART_STAT_TBE_Pos    (7)
#define USART_STAT_TBE_Msk    (0x1UL << USART_STAT_TBE_Pos)
#define USART_STAT_TBE        (USART_STAT_TBE_Msk)
#define USART_STAT_TC_Pos     (6)
#define USART_STAT_TC_Msk     (0x1UL << USART_STAT_TC_Pos)
#define USART_STAT_TC         (USART_STAT_TC_Msk)
#define USART_STAT_RBNE_Pos   (5)
#define USART_STAT_RBNE_Msk   (0x1UL << USART_STAT_RBNE_Pos)
#define USART_STAT_RBNE       (USART_STAT_RBNE_Msk)
#define USART_STAT_IDLEF_Pos  (4)
#define USART_STAT_IDLEF_Msk  (0x1UL << USART_STAT_IDLEF_Pos)
#define USART_STAT_IDLEF      (USART_STAT_IDLEF_Msk)
#define USART_STAT_ORERR_Pos  (3)
#define USART_STAT_ORERR_Msk  (0x1UL << USART_STAT_ORERR_Pos)
#define USART_STAT_ORERR      (USART_STAT_ORERR_Msk)
#define USART_STAT_NERR_Pos   (2)
#define USART_STAT_NERR_Msk   (0x1UL << USART_STAT_NERR_Pos)
#define USART_STAT_NERR       (USART_STAT_NERR_Msk)
#define USART_STAT_FERR_Pos   (1)
#define USART_STAT_FERR_Msk   (0x1UL << USART_STAT_FERR_Pos)
#define USART_STAT_FERR       (USART_STAT_FERR_Msk)
#define USART_STAT_PERR_Pos   (0)
#define USART_STAT_PERR_Msk   (0x1UL << USART_STAT_PERR_Pos)
#define USART_STAT_PERR       (USART_STAT_PERR_Msk)

#define USART_CTL0_UEN    (0x1UL << 13)   //USART enable
#define USART_CTL0_WL     (0x1UL << 12)   //Word length 0:8 data bits 1:9 data bits
#define USART_CTL0_WM     (0x1UL << 11)   //Wakeup method in mute mode 0: Wake up by idle frame 1: Wake up by address match
#define USART_CTL0_PCEN   (0x1UL << 10)   //Parity check 0:disabled   1:Enabled
#define USART_CTL0_PM     (0x1UL << 9)    //Parity mode 0: Even parity 1: Odd parity
#define USART_CTL0_PERRIE (0x1UL << 8)    //Parity error interrupt enable    
#define USART_CTL0_TBEIE  (0x1UL << 7)    //Transmitter buffer empty interrupt enable
#define USART_CTL0_TCIE   (0x1UL << 6)    //Transmission complete interrupt enable
#define USART_CTL0_RBNEIE (0x1UL << 5)    //Read data buffer not empty interrupt and overrun error interrupt enable
#define USART_CTL0_IDLIE  (0x1UL << 4)    //IDLE line detected interrupt enable
#define USART_CTL0_TEN    (0x1UL << 3)    //Transmitter enable
#define USART_CTL0_REN    (0x1UL << 2)    //Receiver enable
#define USART_CTL0_RWU    (0x1UL << 1)    //Receiver wakes up from mute mode.
#define USART_CTL0_SBKCMD (0x1UL << 0)    //Send break command

#define USART_CTL1_LMEN   (0x1UL << 14)   //LIN mode enable
#define USART_CTL1_STB_0  (0x1UL << 13)   //Stop bits length
#define USART_CTL1_STB_1  (0x1UL << 12)   //00: 1 stop bit 01: 0.5 stop bit 10: 2 stop bits 11: 1.5 stop bits
#define USART_CTL1_STB    (0x3UL << 12)
#define USART_CTL1_CKEN   (0x1UL << 11)   //CK pin enable
#define USART_CTL1_CPL    (0x1UL << 10)   //CK polarity
#define USART_CTL1_CPH    (0x1UL << 9)    //CK phase
#define USART_CTL1_CLEN   (0x1UL << 8)    //CK length    
#define USART_CTL1_LBDIE  (0x1UL << 6)    //LIN break detected interrupt enable
#define USART_CTL1_LBLEN  (0x1UL << 5)    //LIN break frame length
#define USART_CTL1_ADDR_0 (0x1UL << 0)    //Address of the USART
#define USART_CTL1_ADDR_1 (0x1UL << 1)    //Address of the USART
#define USART_CTL1_ADDR_2 (0x1UL << 2)    //Address of the USART
#define USART_CTL1_ADDR_3 (0x1UL << 3)    //Address of the USART
